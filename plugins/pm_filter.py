...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAE6J5hlet1gURdQNXPflZl5mhhNOusJLwACgwsAArx2aFamK_GuuoTcMR4E") 
        await m.delete()
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/mihi_ax')
        ],[
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
          ...
          media=InputMediaAnimation(
            media="https://cdn.jsdelivr.net/gh/Jisshubot/JISSHU_BOTS/Video.mp4/Welcome_video_20240921_184741_0001.aud",
       ...
       await client.edit_message_media(
        ...
        await query.answer("Meet me @Mihir-Ax", show_alert=True)
 
    elif query.data == "Source":
        buttons = [[
            InlineKeyboardButton('Repo', url='https://t.me/mihi_ax')
        ],[
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/Suport_MiHiR_AX'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
          message_id=query.message.id,
          media=InputMediaAnimation(
            media="https://cdn.jsdelivr.net/gh/Jisshubot/JISSHU_BOTS/Video.mp4/Group_20240921_202540_0001.aud",
