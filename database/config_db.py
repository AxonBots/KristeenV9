...
from info import DATABASE_URI, DATABASE_NAME  # Make sure we're using the original database
...
mdb = Database(DATABASE_URI, DATABASE_NAME)  # Use the original database name
