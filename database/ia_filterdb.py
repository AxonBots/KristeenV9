...
from info import FILES_DATABASE_URI, FILES_DATABASE_NAME, COLLECTION_NAME, MAX_BTN

# Connect to the files database
client = AsyncIOMotorClient(FILES_DATABASE_URI)
mydb = client[FILES_DATABASE_NAME]
